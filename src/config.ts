...
const FEATURE_PROGRESS_V2_RAW = import.meta.env.VITE_FEATURE_PROGRESS_V2 ?? 'false'
const FEATURE_SCM_RAW = import.meta.env.VITE_FEATURE_SCM ?? 'true'
const FEATURE_SCM_VISUAL_RAW = import.meta.env.VITE_FEATURE_SCM_VISUAL ?? 'true'
...
export const FEATURE_PROGRESS_V2 = FEATURE_PROGRESS_V2_RAW === 'true'
